...
This is a Docker image based on [rubensa/ubuntu-tini-dev](https://github.com/rubensa/docker-ubuntu-tini-dev) 18.04 and chrome for headless development.
...
docker build --no-cache \
  -t "rubensa/ubuntu-tini-dev-chrome:18.04" \
...
docker run --rm -it \
  ...
  ${ENV_VARS} \
  ${RUNNER} \
  rubensa/ubuntu-tini-dev-chrome:18.04 "$@"
```
